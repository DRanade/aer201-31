...
# 104 "operationCode.c"
            ...
            if (PORTCbits.RC0 == 0){
                LATAbits.LATA1 = 1; LATAbits.LATA3 = 0;
            }
            while (PORTCbits.RC0 == 0){
                continue;
            }
            LATAbits.LATA1 = 0; LATAbits.LATA3 = 0;

            _delay((unsigned long)((10)*(10000000/4000.0)));

            LATAbits.LATA5 = 1; LATDbits.LATD1 = 1;
            ...
            LATAbits.LATA1 = 0; LATAbits.LATA3 = 1;
            ...
            infoArr[*pNumPoles].pos = posTurns*44 + pos*9;
            ...
            tireDeploy(tireVar,(*pTotalSupplied)%2);
            ...
            *pNumPoles += 1;
            ...
            LATAbits.LATA5 = 1; LATDbits.LATD1 = 0;
