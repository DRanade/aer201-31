...
volatile _Bool int1Pressed = 0;
volatile _Bool int0Pressed = 0;
unsigned char totalTime = 0;
unsigned char tiresSupp = 0;
unsigned char poleCount = 0;
unsigned char currPole = 0;
poleInfo poleInfoArr[15];

unsigned char tick = 0;

unsigned char lastStored = 3;
...
void main(void){
    ...
    TRISA = 0b11000000; TRISB = 0b11111111;
    TRISC = 0b11011001; TRISD = 0b00000000; TRISE = 0b00001110;

    LATDbits.LATD1 = 0; LATAbits.LATA5 = 0;
